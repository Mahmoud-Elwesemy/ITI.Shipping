...
public class ShippingTypeController:ControllerBase
{
    ...
    public async Task<ActionResult<IEnumerable<ShippingTypeDTO>>> GetAllShippingType()
    {
        var allShippingType =await _serviceManager.shippingTypeService.GetAllShippingTypeAsync();
